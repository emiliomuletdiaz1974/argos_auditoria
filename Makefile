...
cover:
	uv run pytest -m "not heavy" --cov=argos_common --cov=argos_events --cov=argos_auth --cov=argos_connector --cov=argos_sql --cov=argos_files --cov=argos_rest --cov=argos_ldap --cov-report=term-missing --cov-fail-under=80
