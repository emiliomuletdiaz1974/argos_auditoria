...
// token in an HttpOnly cookie that only `/api/v1/auth/refresh` sees, and answers with the access
// token alone. That token lives in this object's memory and nowhere else: not in localStorage, not
